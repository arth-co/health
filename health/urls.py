...
urlpatterns = patterns('',
    ...
    url(r'^city_list/', 'hospitals.views.city_list', name='city_list'),
    ...
    url(r'^query_similar_hospitals/', 'hospitals.views.query_similar_hospitals', name='query_similar_hospitals'),
